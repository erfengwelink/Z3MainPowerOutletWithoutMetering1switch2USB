...
#define BSP_BUTTON0_PIN                       (2U)//(4U)//
#define BSP_BUTTON0_PORT                      (gpioPortD)//4U)//(gpioPortC)//
...
#define BSP_LED0_PIN                          (0U)//(3U)
#define BSP_LED0_PORT                         (gpioPortB)//(gpioPortD) // sw status led (gpioPortC)//

#define BSP_LED1_PIN                          (1U)//(4U) //(5U)//
#define BSP_LED1_PORT                         (gpioPortB)//(gpioPortD)  net ststus led (gpioPortC)//
...
// $[SW]
#define BSP_SW1_PIN                          (1U)
#define BSP_SW1_PORT                         (gpioPortC)// main power pin

#define BSP_SW2_PIN                          (4U)//(2U)
#define BSP_SW2_PORT                         (gpioPortD)//(gpioPortC) //usb1 pin

#define BSP_SW3_PIN                          (0U)
#define BSP_SW3_PORT                         (gpioPortC)// //usb2 pin

#define BSP_SW_COUNT                         (3U)
#define BSP_SW_INIT                          { { BSP_SW1_PORT, BSP_SW1_PIN }, { BSP_SW2_PORT, BSP_SW2_PIN }, {BSP_SW3_PORT, BSP_SW3_PIN} }
#define HAL_SW_COUNT                         (3U)
#define HAL_SW_ENABLE                        { 0, 1, 2 }
#define BSP_SW_POLARITY                      (1)
...
#define PORTIO_PTI_DFRAME_PORT                (gpioPortC) // consider 768k soc solution!!!!!!!!!!!!!!!!!!!!!
